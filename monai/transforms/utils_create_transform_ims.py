...
if __name__ == "__main__":
    ...
    create_transform_im(
        RandSpatialCropSamples, dict(num_samples=4, spatial_size=(100, 100, 100), random_size=False), data
    )
    create_transform_im(
        RandSpatialCropSamplesd,
        dict(keys=keys, num_samples=4, spatial_size=(100, 100, 100), random_size=False),
        data,
    )
    create_transform_im(
