...
TEST_SHAPES = [
    ...
    [
        {"keys": "img", "spatial_size": [3, 2, 3], "random_center": False, "random_size": False},
        (3, 3, 3, 3),
        (3, 3, 2, 3),
    ],
]
...
TEST_RANDOM_SHAPES = [
    ...
    [
        {"keys": "img", "spatial_size": 3, "max_roi_size": 4, "random_center": True, "random_size": True},
        (1, 4, 5, 6),
        (1, 3, 4, 3),
    ],
]
...
func1 = {
    RandSpatialCropd: {"keys": "img", "spatial_size": [8, 7, -1], "random_center": True, "random_size": False}
}
...
class TestRandSpatialCropd(CropTest):
    ...
    def test_deprecated_roi_size(self):
        ...
        expected = RandSpatialCropd("img", (2, 2), random_center=False)(data)["img"]
        with self.assertWarnsRegex(FutureWarning, "spatial_size"):
            result = RandSpatialCropd(keys="img", roi_size=(2, 2), random_center=False)(data)["img"]
